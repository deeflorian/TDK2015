...
\end{tabular}	
		...
		\subsection{Finite State Machine}
			\begin{dfn}
				\label{dfn:cep:fsm}
				A FiniteStateMachine $\langle Q,\Sigma,\delta,q_0, F \rangle$ tuple where:
					\begin{itemize}
						\item $Q$ is a finite, non empty set. These are the states of the automaton.
						\item $\Sigma$ is a finite, non empty set. This is the abc of the automaton.
						\item $\delta$ : $Q \times \Sigma \rightarrow Q$, the state transition function of the automaton.
			...
			\begin{dfn}
				A NonDeterministic FiniteStateMachine $\langle Q,\Sigma,\delta,q_0, F \rangle$ where 
